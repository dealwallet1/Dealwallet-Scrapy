...
CSV_FILE = r"C:\Users\batti\Downloads\amazon-11(in).csv"
 
STORE_ID = "80ca4dee-d51f-4cad-a01a-27c1dd6ea2ea"
 
ORGANIZATION_ID = "0195fae1-1e74-7f83-82db-b3031ddcbde1"
 
CATEGORIES_ID = "f0be33e2-086a-4af2-a813-a2fe842638ed"
...
def convert_to_cuelinks(product_url):
 
    if not product_url or product_url in (
        "N/A",
        " "
    ):
        print("[CUELINKS] Empty product URL")
        return " "
