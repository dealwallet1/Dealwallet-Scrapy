...
STORE_ID = "67c9ab38-7238-49a2-9a79-2e5d298d378c"
...
async def scrape_product_price(
    ...
    try:
        ...
        if price_box:
            ...
            price_tag = price_box.select_one(
                "span.current-price"
            )
...
def save_price_history(
    ...
    if product_price == scraped_price:
        ...
        if not history_row:
            ...
            print(
                "NEW HISTORY ROW - PRICE SAME - -- INSERTED"
            )
    ...
    if not history_row:
        ...
        current_prices = calculate_prices(
...
async def main():
    ...
    async with AsyncWebCrawler(
        ...
        for index, product in enumerate(
            ...
            scraped_price = await scrape_product_price(
